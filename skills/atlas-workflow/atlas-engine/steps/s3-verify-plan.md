...
1. **The S2 plan artifact** for this slice: `atlas/initiatives/<id>/.../plan.md` (path is passed in
...
Write `atlas/initiatives/<id>/.../plan-verification.md` next to the slice's `plan.md`. Fresh-context bar
...
artifactPath:    "atlas/initiatives/<id>/.../plan-verification.md"
