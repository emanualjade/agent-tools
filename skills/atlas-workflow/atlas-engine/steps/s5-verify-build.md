...
modules below. **You write:** `atlas/initiatives/<id>/phases/<phaseId>/slices/<sliceId>/build-verification.md`.
...
Write to `atlas/initiatives/<id>/phases/<phaseId>/slices/<sliceId>/build-verification.md`. **Fresh-context bar**
