...
- The **phase spec** + the phase's **acceptance criteria** (S1 artifact under
  `atlas/initiatives/<id>/phases/<phase-id>/`) — the external objective you verdict against.
...
- `main_spec_covered` — repeat criterion 2's verbatim per-criterion table against the **main-spec
  acceptance criteria** (S0 artifact, `atlas/initiatives/<id>/main-spec.md`), not just the phase
...
Write `atlas/initiatives/<id>/phases/<phase-id>/verification.md` containing: the five named-criterion
