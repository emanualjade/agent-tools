...
Into the target repo (cwd-relative), under `atlas/initiatives/<initiativeId>/`:
...
artifactPath:     "atlas/initiatives/<id>/main-spec.md"   // + development-plan.md
...
changedFiles:     ["atlas/initiatives/<id>/main-spec.md",
                   "atlas/initiatives/<id>/development-plan.md"]
