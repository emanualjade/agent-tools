...
- **`build.md`** — `strike/initiatives/<id>/.../<slice-id>/build.md`: the inline grounding note;
...
- **On any Tier-3 obstruction:** the committed **ADR** at `strike/initiatives/<id>/adr/NNN-slug.md`
...
artifactPath:   "strike/initiatives/<id>/.../<slice-id>/build.md"
