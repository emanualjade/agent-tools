export const meta = {
  name: 'review-atlas',
  description: 'Adversarial review of the Atlas v2 engine + modules: fan out correctness/contract/obstruction/verification/leanness/resume lenses, adversarially verify each finding (schema-authoritative runtime kills false positives), synthesize a confirmed fix list.',
  phases: [
...
const base = 'You are reviewing the Atlas v2 build workflow for production-readiness. Read:\n' +
  '  - ' + ENGINE + '  (the engine)\n' +
