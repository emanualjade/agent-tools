export const meta = {
  ...
  description: 'Evaluate the first real Atlas v2 dogfood build (houseplant tracker in ~/Sites/workflow-dogfood): code quality, slicing discipline, verification honesty, a 9-failure-mode scorecard, the integration/coverage bugs, and efficiency/timing — then synthesize an improvement report.',
  phases: [
...
const STK = DF + '/atlas/initiatives/initiative'   // the build wrote here (id mismatch)
const FRONT = DF + '/atlas/initiatives/houseplant-tracker'  // front door wrote here
