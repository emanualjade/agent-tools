export const meta = {
  ...
  description: 'Adversarial review of the FAST-lane plan+build merge in atlas.mjs runSlice: control-flow/termination correctness, verification-preserved (S5 always runs; promoted slices still get S3), and edge/schema soundness.',
  phases: [
...
const STEP = '/Users/cracklehat/Sites/workflow-exploration/atlas-engine/steps/s2s4-fast-plan-build.md'
const DESIGN = '/Users/cracklehat/Sites/workflow-exploration/atlas-engine/DESIGN.md'
...
const base = 'Adversarially review the FAST-lane plan+build MERGE in the Atlas v2 engine. Read ' + ENGINE + ' (focus on runSlice), the new step ' + STEP + ', and ' + DESIGN + ' as needed.\n\n' + CTX + '\n\nYOUR LENS: '
const LENSES = [
