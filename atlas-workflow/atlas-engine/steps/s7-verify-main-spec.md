...
- the **main-spec** + phase-map at `atlas/initiatives/<id>/` (S0's artifact) — the acceptance
...
### 1. `verification.md` at `atlas/initiatives/<id>/verification.md`
...
artifactPath:    "atlas/initiatives/<id>/verification.md"
