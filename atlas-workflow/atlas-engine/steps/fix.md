...
- **Numbered `fix-NNN.md`** (`atlas/initiatives/<id>/phases/<phaseId>/slices/<sliceId>/fix-NNN.md`,
...
- **On any Tier-3 obstruction** (§5): the committed **ADR** at
  `atlas/initiatives/<id>/adr/NNN-slug.md` **and** the `ARCH-DEBT(<slice-id>)` **marker** at the
