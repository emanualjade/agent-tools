...
- **One `slice.md` per slice** at `atlas/initiatives/<id>/phases/<phase-id>/slices/<slice-id>/slice.md`.
...
- **Phase-spec** (§2): for a **MERGED** phase, it is the header block of the phase dir
  (`atlas/initiatives/<id>/phases/<phase-id>/phase-spec.md`, brief). For a **SPLIT** phase, the same
...
artifactPath:    "atlas/initiatives/<id>/phases/<phase-id>/"   # the phase dir
